...
public class ObjetExemple {
    ...
    public ObjetExemple(int id, String nom, String postnom, String prenom, String adresse, int idUtilisateur, String nomUtilisateur, double salaire, int sexe, String fonction, String dateEnreg, int tailleResultat) {
        this.id = id;
        this.nom = nom;
